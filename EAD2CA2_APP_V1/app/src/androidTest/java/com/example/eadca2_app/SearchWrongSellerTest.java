...
public class SearchWrongSellerTest {

    @Rule
    public ActivityTestRule<MainActivity> mActivityTestRule = new ActivityTestRule<>(MainActivity.class);

    @Test
    public void searchWrongSellerTest() {
        ...
        ViewInteraction textView = onView(
                allOf(withId(R.id.sellerTextView), withText("Sorry, search again : tobi"),
                        withParent(allOf(withId(R.id.relativeLayout2),
                                withParent(withId(android.R.id.content)))),
                        isDisplayed()));
        textView.check(matches(withText("Sorry, search again : tobi")));

        ViewInteraction editText = onView(
                allOf(withId(R.id.search_bar2), withText("tobi"),
                        withParent(allOf(withId(R.id.relativeLayout2),
                                withParent(withId(android.R.id.content)))),
                        isDisplayed()));
        editText.check(matches(withText("tobi")));
    }
